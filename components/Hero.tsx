      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="max-w-2xl">
          ...
          <p className="text-lg text-gray-200 mb-8 leading-relaxed max-w-lg">
            S.R.B Engineering & Construction Pvt. Ltd. delivers tailored engineering consulting and premium construction services, with sustainability and trust at the core of everything we do.
          </p>
